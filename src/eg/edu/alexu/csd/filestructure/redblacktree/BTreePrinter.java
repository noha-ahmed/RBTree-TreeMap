...
class BTreePrinter {
    ...
    private static <T extends Comparable<?>> void printNodeInternal(List<INode> nodes, int level, int maxLevel) {
    ...
    private static <T extends Comparable<?>> int maxLevel(INode node) {
        if (node == null)
            return 0;
